...
chrome.storage.onChanged.addListener((changes) => {
    ...
    if (changes.apiRegion)
        apiRegion = changes.apiRegion.newValue;
...
async function handleTranslationRequest(text, targetLang) {
...
async function handleDirectTest(text, targetLang) {
